    ...
    _init: function () {
        ...
        function handleClick(dom) {
            return function (e) {
                ...
                rlines.push([["Field name", "errorGuess"],
                                 ["Field value", t.error]]);
        ...
        var dom = htmlCodeToDOM(this.html, function (dom) {
            ...
            if (t.continueOnReturn) {
                t.safeBind($(dom).find("input[type=text]"), 'keydown', function (e) { if (e.keyCode == 13) {t.error = document.getElementById("datatosend").value; console.log("H"); return handler(e);} });
